...
const ProButton$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  static get style() { return proButtonCss; }
};

const ProButton = /*@__PURE__*/proxyCustomElement(ProButton$1, [1,"pro-button",{"variant":[1],"size":[1],"disabled":[4]}]);
...
export { ProButton, defineCustomElements };
