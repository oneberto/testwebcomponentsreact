 ...
 */
const patchBrowser = () => {
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('prodigio-components.cjs.js', document.baseURI).href));
    const opts = {};
    if (importMeta !== '') {
